  ...
  return (
    <div>
      <div className='flex justify-around container mx-auto w-[80%] max-w-xl mb-48 animte'>
        ...
        <a href='https://github.com/GomezAnthony'><FaTwitch className='text-secondary-color text-4xl md:text-5xl cursor-pointer hover:text-tertiary-color hover:scale-125 duration-700 ease-in-out transition delay-75' /></a>
      </div>
    </div>
  )
}
